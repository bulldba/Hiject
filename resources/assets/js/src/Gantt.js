...
Hiject.Gantt.prototype.execute = function() {
...
Hiject.Gantt.prototype.saveRecord = function(record) {
...
Hiject.Gantt.prototype.show = function() {
...
Hiject.Gantt.prototype.renderVerticalHeader = function() {
...
Hiject.Gantt.prototype.renderSlider = function(startDate, endDate) {
...
Hiject.Gantt.prototype.renderHorizontalHeader = function(dates) {
...
// Render grid
Hiject.Gantt.prototype.renderGrid = function(dates) {
...
Hiject.Gantt.prototype.addBlockContainers = function() {
...
// Render bars
Hiject.Gantt.prototype.addBlocks = function(slider, start) {
...
Hiject.Gantt.prototype.getVerticalHeaderTooltip = function(record) {
    var tooltip = "";
...
Hiject.Gantt.prototype.getBarTooltip = function(record) {
    var tooltip = "";
...
// Set bar color
Hiject.Gantt.prototype.setBarColor = function(block, record) {
    if (record.not_defined) {
...
Hiject.Gantt.prototype.listenForBlockResize = function(startDate) {
    var self = this;
...
Hiject.Gantt.prototype.listenForBlockMove = function(startDate) {
    var self = this;
...
Hiject.Gantt.prototype.updateDataAndPosition = function(block, startDate) {
...
Hiject.Gantt.prototype.getDates = function(start, end) {
    var dates = [];
...
Hiject.Gantt.prototype.prepareData = function(data) {
...
Hiject.Gantt.prototype.getDateRange = function(minDays) {
...
Hiject.Gantt.prototype.daysBetween = function(start, end) {
    if (! start || ! end) {
        return 0;
    }
...
Hiject.Gantt.prototype.isWeekend = function(date) {
    return date.getDay() % 6 == 0;
};

// Clone Date object
Hiject.Gantt.prototype.cloneDate = function(date) {
    return new Date(date.getTime());
};

// Add days to a Date object
Hiject.Gantt.prototype.addDays = function(date, value) {
 ...
 */
Hiject.Gantt.prototype.compareDate = function(date1, date2) {
