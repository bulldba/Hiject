...
return array(
    ...
    'view the task on Hiject' => '在看板中查看此任务',
    'Public access' => '公开访问',
    'Active tasks' => '已激活的任务',
    ...
    'Period (in second) to consider a task was modified recently (0 to disable, 2 days by default)' => '多久内的任务视作刚刚修改(单位：秒,设置为0禁用，默认是2天',
    'Frequency in second (60 seconds by default)' => '频率,单位为秒(默认是60秒)',
    'Frequency in second (0 to disable this feature, 10 seconds by default)' => '频率,单位为秒(设置为0禁用此功能，默认是10秒)',
    ...
    '%s removed the assignee of the task %s' => '%s删除了任务%s的被指派人',
    ...
    'view the board on Hiject' => '在看板上查看面板',
    ...
    'Time spent changed: %sh' => '实际工时已变更：%sh',
    'Time estimated changed: %sh' => '计划工时已变更：%sh',
    ...
    'There is no activity yet.' => '还没有任何动态.',
    ...
    'New remote user' => '新加绑定用户',
    'New local user' => '新加原生用户',
    ...
    'Start date:' => '开始日期：',
    'Due date:' => '截止日期：',
    'There is no start date or due date for this task.' => '当前任务没有开始或截止日期。',
    ...
    'Column changed for task #%d' => '任务#%d的任务栏已变更',
    'New position for task #%d' => '任务#%d的新状态',
    'Swimlane changed for task #%d' => '任务#%d的里程碑已变更',
    'Assignee changed on task #%d' => '任务#%d的指派人已变更',
    ...
    'Do you really want to remove this group: "%s"?' => '你真的想要删除用户组："%s"？',
    ...
    'Password Reset for Hiject' => '重置kanboard密码',
    ...
    'Do you really want to remove this custom filter: "%s"?' => '你确定要删除这个自定义过滤器："%s"？',
    'Remove a custom filter' => '删除自定义过滤器',
    ...
    'User not found.' => '查无此人',
    'Search in activity stream' => '在动态中搜索',
    'My activities' => '我的动态',
    ...
    // 'Your Hiject instance is not configured to install plugins from the user interface.' => '',
    ...
    'Global tags' => '全局标签',
    'There is no global tag at the moment.' => '当前还没有新的全局标签',
    ...
    'Automatically set the due date on task creation' => '当任务创建时自动设置截止日期',
    ...
    'Dashboard for %s' => '%s 的控制台',
    'Tasks overview for %s' => ' %s 的任务',
    'Subtasks overview for %s' => '%s 的子任务',
    'Projects overview for %s' => '%s 的项目',
    'Activity stream for %s' => '%s 的动态',
    'Calendar for %s' => '%s 的日程表',
    'Notifications for %s' => '%s 的通知',
    // 'Subtasks export' => '',
    // 'Tasks exportation' => '',
    'Assign a color when the task is moved to a specific swimlane' => '任务移动到指定里程碑，设置颜色',
